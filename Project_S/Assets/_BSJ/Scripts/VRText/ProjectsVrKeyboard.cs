...
public class ProjectsVrKeyboard : MonoBehaviour
{
    [SerializeField]
    ...
    List<ProjectsVrKeyboard> KeyboardKeys;

    void Awake()
    {
        KeyboardKeys = transform.GetComponentsInChildren<ProjectsVrKeyboard>().ToList();
    }
